  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        aria-label="WhatsApp CAR SHOW"
        className="fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#E10600] text-sm font-black text-white shadow-2xl shadow-[#E10600]/30 transition hover:scale-105 hover:bg-[#b60500]"
      >
        WA
      </a>
    </div>
